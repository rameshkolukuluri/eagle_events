...
/**
 * Servlet implementation class FetchSingleGuestServlet
 */
@WebServlet("/FetchSingleGuestServlet")
public class FetchSingleGuestServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public FetchSingleGuestServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		GuestInfo guestInfo = guestDao.readbyguestidandeventid(eventid, guestid);
